 ...
 */
export type TodoColor = 'red' | 'orange' | 'yellow' | 'green' | 'blue' | 'purple' | 'pink' | 'gray'
 ...
 * Color configuration
 */
export const TODO_COLORS: Record<TodoColor, { bg: string; text: string; border: string }> = {
  red: { bg: 'bg-todo-red', text: 'text-todo-red', border: 'border-todo-red' },
  orange: { bg: 'bg-todo-orange', text: 'text-todo-orange', border: 'border-todo-orange' },
  yellow: { bg: 'bg-todo-yellow', text: 'text-todo-yellow', border: 'border-todo-yellow' },
  green: { bg: 'bg-todo-green', text: 'text-todo-green', border: 'border-todo-green' },
  blue: { bg: 'bg-todo-blue', text: 'text-todo-blue', border: 'border-todo-blue' },
  purple: { bg: 'bg-todo-purple', text: 'text-todo-purple', border: 'border-todo-purple' },
  pink: { bg: 'bg-todo-pink', text: 'text-todo-pink', border: 'border-todo-pink' },
  gray: { bg: 'bg-todo-gray', text: 'text-todo-gray', border: 'border-todo-gray' },
}
